module github.com/lechnerc77/pulumi-btp/provider
...
require (
	github.com/SAP/terraform-provider-btp/shim v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/SAP/terraform-provider-btp v0.6.0-beta2 // indirect
