...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"btp_globalaccount_security_settings":          {Tok: makeResource(mainMod, "btp_globalaccount_security_settings")},
			...
			"btp_subaccount_security_settings":             {Tok: makeResource(mainMod, "btp_subaccount_security_settings")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"btp_directories":                        {Tok: makeDataSource(mainMod, "btp_directories")},
			...
			"btp_globalaccount_security_settings":    {Tok: makeDataSource(mainMod, "btp_globalaccount_security_settings")},
			...
			"btp_subaccount_security_settings":       {Tok: makeDataSource(mainMod, "btp_subaccount_security_settings")},
