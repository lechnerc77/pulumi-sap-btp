...
namespace PulumiBtp.Btp.Outputs
{
    ...
    [OutputType]
    public sealed class GetDirectoryRolesValueResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDirectoryRolesValueScopeResult> Scopes;

        [OutputConstructor]
        private GetDirectoryRolesValueResult(
            string appId,
            ...
            ImmutableArray<Outputs.GetDirectoryRolesValueScopeResult> scopes)
        {
            AppId = appId;
            AppName = appName;
