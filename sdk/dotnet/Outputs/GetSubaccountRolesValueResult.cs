...
namespace PulumiBtp.Btp.Outputs
{
    ...
    [OutputType]
    public sealed class GetSubaccountRolesValueResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSubaccountRolesValueScopeResult> Scopes;

        [OutputConstructor]
        private GetSubaccountRolesValueResult(
            string appId,
            ...
            ImmutableArray<Outputs.GetSubaccountRolesValueScopeResult> scopes)
        {
            AppId = appId;
            AppName = appName;
