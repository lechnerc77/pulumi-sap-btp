...
namespace PulumiBtp.Btp
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/lechnerc77/pulumi-btp";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PulumiBtp.Btp.version.txt");
    ...
    internal sealed class BtpResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public BtpResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
