...
@CustomType
public final class GetSubaccountRoleScope {
    ...
    private GetSubaccountRoleScope() {}
    ...
    public static Builder builder(GetSubaccountRoleScope defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetSubaccountRoleScope defaults) {
        ...
        public GetSubaccountRoleScope build() {
            final var _resultValue = new GetSubaccountRoleScope();
