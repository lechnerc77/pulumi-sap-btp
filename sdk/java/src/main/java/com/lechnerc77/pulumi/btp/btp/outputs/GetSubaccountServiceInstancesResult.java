...
import com.lechnerc77.pulumi.btp.btp.outputs.GetSubaccountServiceInstancesValue;
...
@CustomType
public final class GetSubaccountServiceInstancesResult {
    /**
    ...
    private List<GetSubaccountServiceInstancesValue> values;
    ...
    public List<GetSubaccountServiceInstancesValue> values() {
        return this.values;
    }
    ...
    public static Builder builder(GetSubaccountServiceInstancesResult defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetSubaccountServiceInstancesValue> values;
        public Builder() {}
        public Builder(GetSubaccountServiceInstancesResult defaults) {
        ...
        @CustomType.Setter
        public Builder values(List<GetSubaccountServiceInstancesValue> values) {
            this.values = Objects.requireNonNull(values);
            return this;
        }
        public Builder values(GetSubaccountServiceInstancesValue... values) {
            return values(List.of(values));
        }
        public GetSubaccountServiceInstancesResult build() {
            final var _resultValue = new GetSubaccountServiceInstancesResult();
