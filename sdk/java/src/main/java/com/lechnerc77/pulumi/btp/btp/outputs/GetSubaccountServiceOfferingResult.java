...
@CustomType
public final class GetSubaccountServiceOfferingResult {
    /**
    ...
    public static Builder builder(GetSubaccountServiceOfferingResult defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> tags;
        public Builder() {}
        public Builder(GetSubaccountServiceOfferingResult defaults) {
        ...
        public GetSubaccountServiceOfferingResult build() {
            final var _resultValue = new GetSubaccountServiceOfferingResult();
