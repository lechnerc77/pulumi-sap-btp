...
@CustomType
public final class GetGlobalaccountRolesValueScope {
    ...
    private GetGlobalaccountRolesValueScope() {}
    ...
    public static Builder builder(GetGlobalaccountRolesValueScope defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetGlobalaccountRolesValueScope defaults) {
        ...
        public GetGlobalaccountRolesValueScope build() {
            final var _resultValue = new GetGlobalaccountRolesValueScope();
