...
public final class GlobalaccountRoleCollectionRoleArgs extends com.pulumi.resources.ResourceArgs {

    public static final GlobalaccountRoleCollectionRoleArgs Empty = new GlobalaccountRoleCollectionRoleArgs();
    ...
    private GlobalaccountRoleCollectionRoleArgs() {}

    private GlobalaccountRoleCollectionRoleArgs(GlobalaccountRoleCollectionRoleArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(GlobalaccountRoleCollectionRoleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GlobalaccountRoleCollectionRoleArgs();
        }

        public Builder(GlobalaccountRoleCollectionRoleArgs defaults) {
            $ = new GlobalaccountRoleCollectionRoleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GlobalaccountRoleCollectionRoleArgs build() {
