...
@CustomType
public final class GetGlobalaccountRoleCollectionsValueRole {
    private String description;
    private String name;
    private String roleTemplateAppId;
    private String roleTemplateName;

    private GetGlobalaccountRoleCollectionsValueRole() {}
    ...
    public static Builder builder(GetGlobalaccountRoleCollectionsValueRole defaults) {
    ...
    public static final class Builder {
        ...
        private String roleTemplateName;
        public Builder() {}
        public Builder(GetGlobalaccountRoleCollectionsValueRole defaults) {
        ...
        public GetGlobalaccountRoleCollectionsValueRole build() {
            final var _resultValue = new GetGlobalaccountRoleCollectionsValueRole();
