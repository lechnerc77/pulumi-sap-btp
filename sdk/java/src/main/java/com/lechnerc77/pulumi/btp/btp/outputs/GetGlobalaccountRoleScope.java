...
@CustomType
public final class GetGlobalaccountRoleScope {
    ...
    private GetGlobalaccountRoleScope() {}
    ...
    public static Builder builder(GetGlobalaccountRoleScope defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetGlobalaccountRoleScope defaults) {
        ...
        public GetGlobalaccountRoleScope build() {
            final var _resultValue = new GetGlobalaccountRoleScope();
