...
import com.lechnerc77.pulumi.btp.btp.GlobalaccountRoleCollectionAssignmentArgs;
import com.lechnerc77.pulumi.btp.btp.Utilities;
import com.lechnerc77.pulumi.btp.btp.inputs.GlobalaccountRoleCollectionAssignmentState;
 ...
 * 
 */
@ResourceType(type="btp:index/globalaccountRoleCollectionAssignment:GlobalaccountRoleCollectionAssignment")
public class GlobalaccountRoleCollectionAssignment extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public GlobalaccountRoleCollectionAssignment(String name) {
        this(name, GlobalaccountRoleCollectionAssignmentArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GlobalaccountRoleCollectionAssignment(String name, GlobalaccountRoleCollectionAssignmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GlobalaccountRoleCollectionAssignment(String name, GlobalaccountRoleCollectionAssignmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("btp:index/globalaccountRoleCollectionAssignment:GlobalaccountRoleCollectionAssignment", name, args == null ? GlobalaccountRoleCollectionAssignmentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GlobalaccountRoleCollectionAssignment(String name, Output<String> id, @Nullable GlobalaccountRoleCollectionAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("btp:index/globalaccountRoleCollectionAssignment:GlobalaccountRoleCollectionAssignment", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static GlobalaccountRoleCollectionAssignment get(String name, Output<String> id, @Nullable GlobalaccountRoleCollectionAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
