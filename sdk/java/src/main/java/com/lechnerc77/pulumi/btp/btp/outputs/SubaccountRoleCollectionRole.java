...
@CustomType
public final class SubaccountRoleCollectionRole {
    /**
    ...
    private SubaccountRoleCollectionRole() {}
    /**
     * @return The name of the referenced role.
     * 
     */
    ...
    public static Builder builder(SubaccountRoleCollectionRole defaults) {
    ...
    public static final class Builder {
        ...
        private String roleTemplateName;
        public Builder() {}
        public Builder(SubaccountRoleCollectionRole defaults) {
        ...
        public SubaccountRoleCollectionRole build() {
            final var _resultValue = new SubaccountRoleCollectionRole();
