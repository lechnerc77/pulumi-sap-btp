...
@CustomType
public final class GetSubaccountsValue {
    /**
    ...
    /**
     * @return The unique ID of the subaccount.
     * 
     */
    private String id;
    /**
    ...
    public static Builder builder(GetSubaccountsValue defaults) {
    ...
    public static final class Builder {
        ...
        private String usage;
        public Builder() {}
        public Builder(GetSubaccountsValue defaults) {
        ...
        public GetSubaccountsValue build() {
            final var _resultValue = new GetSubaccountsValue();
