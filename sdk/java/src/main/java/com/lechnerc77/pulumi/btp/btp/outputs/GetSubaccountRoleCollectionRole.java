...
@CustomType
public final class GetSubaccountRoleCollectionRole {
    /**
    ...
    private GetSubaccountRoleCollectionRole() {}
    /**
     * @return The description of the referenced role
     * 
     */
    ...
    public static Builder builder(GetSubaccountRoleCollectionRole defaults) {
    ...
    public static final class Builder {
        ...
        private String roleTemplateName;
        public Builder() {}
        public Builder(GetSubaccountRoleCollectionRole defaults) {
        ...
        public GetSubaccountRoleCollectionRole build() {
            final var _resultValue = new GetSubaccountRoleCollectionRole();
