...
@CustomType
public final class GetDirectoryRoleCollectionRole {
    /**
    ...
    private GetDirectoryRoleCollectionRole() {}
    /**
     * @return The description of the referenced role
     * 
     */
    ...
    public static Builder builder(GetDirectoryRoleCollectionRole defaults) {
    ...
    public static final class Builder {
        ...
        private String roleTemplateName;
        public Builder() {}
        public Builder(GetDirectoryRoleCollectionRole defaults) {
        ...
        public GetDirectoryRoleCollectionRole build() {
            final var _resultValue = new GetDirectoryRoleCollectionRole();
