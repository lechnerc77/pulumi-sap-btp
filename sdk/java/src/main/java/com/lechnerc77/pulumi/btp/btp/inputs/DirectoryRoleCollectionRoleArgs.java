...
public final class DirectoryRoleCollectionRoleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DirectoryRoleCollectionRoleArgs Empty = new DirectoryRoleCollectionRoleArgs();
    ...
    private DirectoryRoleCollectionRoleArgs() {}

    private DirectoryRoleCollectionRoleArgs(DirectoryRoleCollectionRoleArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(DirectoryRoleCollectionRoleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DirectoryRoleCollectionRoleArgs();
        }

        public Builder(DirectoryRoleCollectionRoleArgs defaults) {
            $ = new DirectoryRoleCollectionRoleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DirectoryRoleCollectionRoleArgs build() {
