...
@CustomType
public final class GetSubaccountRolesValueScope {
    ...
    private GetSubaccountRolesValueScope() {}
    ...
    public static Builder builder(GetSubaccountRolesValueScope defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetSubaccountRolesValueScope defaults) {
        ...
        public GetSubaccountRolesValueScope build() {
            final var _resultValue = new GetSubaccountRolesValueScope();
