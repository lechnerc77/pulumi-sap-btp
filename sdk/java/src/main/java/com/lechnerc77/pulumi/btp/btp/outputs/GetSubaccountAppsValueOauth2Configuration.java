...
@CustomType
public final class GetSubaccountAppsValueOauth2Configuration {
    ...
    private GetSubaccountAppsValueOauth2Configuration() {}
    ...
    public static Builder builder(GetSubaccountAppsValueOauth2Configuration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer tokenValidity;
        public Builder() {}
        public Builder(GetSubaccountAppsValueOauth2Configuration defaults) {
        ...
        public GetSubaccountAppsValueOauth2Configuration build() {
            final var _resultValue = new GetSubaccountAppsValueOauth2Configuration();
