...
@CustomType
public final class GetDirectoryRolesValueScope {
    ...
    private GetDirectoryRolesValueScope() {}
    ...
    public static Builder builder(GetDirectoryRolesValueScope defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetDirectoryRolesValueScope defaults) {
        ...
        public GetDirectoryRolesValueScope build() {
            final var _resultValue = new GetDirectoryRolesValueScope();
