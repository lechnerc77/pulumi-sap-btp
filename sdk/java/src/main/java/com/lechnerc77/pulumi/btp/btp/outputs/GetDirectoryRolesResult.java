...
import com.lechnerc77.pulumi.btp.btp.outputs.GetDirectoryRolesValue;
...
public final class GetDirectoryRolesResult {
    ...
    private String id;
    private List<GetDirectoryRolesValue> values;
    ...
    public List<GetDirectoryRolesValue> values() {
        return this.values;
    }
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder values(List<GetDirectoryRolesValue> values) {
            this.values = Objects.requireNonNull(values);
            return this;
        }
        public Builder values(GetDirectoryRolesValue... values) {
