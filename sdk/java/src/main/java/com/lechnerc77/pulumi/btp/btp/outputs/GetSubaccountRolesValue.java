...
import com.lechnerc77.pulumi.btp.btp.outputs.GetSubaccountRolesValueScope;
...
@CustomType
public final class GetSubaccountRolesValue {
    /**
     ...
     * 
     */
    private List<GetSubaccountRolesValueScope> scopes;

    private GetSubaccountRolesValue() {}
    /**
     * @return The id of the application that provides the role template and the role.
     * 
     */
     ...
     * 
     */
    public List<GetSubaccountRolesValueScope> scopes() {
        return this.scopes;
    }
    ...
    public static Builder builder(GetSubaccountRolesValue defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetSubaccountRolesValueScope> scopes;
        public Builder() {}
        public Builder(GetSubaccountRolesValue defaults) {
        ...
        @CustomType.Setter
        public Builder scopes(List<GetSubaccountRolesValueScope> scopes) {
            this.scopes = Objects.requireNonNull(scopes);
            return this;
        }
        public Builder scopes(GetSubaccountRolesValueScope... scopes) {
            return scopes(List.of(scopes));
        }
        public GetSubaccountRolesValue build() {
            final var _resultValue = new GetSubaccountRolesValue();
