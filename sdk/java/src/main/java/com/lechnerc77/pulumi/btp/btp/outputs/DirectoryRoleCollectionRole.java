...
@CustomType
public final class DirectoryRoleCollectionRole {
    /**
    ...
    private DirectoryRoleCollectionRole() {}
    /**
     * @return The name of the referenced role.
     * 
     */
    ...
    public static Builder builder(DirectoryRoleCollectionRole defaults) {
    ...
    public static final class Builder {
        ...
        private String roleTemplateName;
        public Builder() {}
        public Builder(DirectoryRoleCollectionRole defaults) {
        ...
        public DirectoryRoleCollectionRole build() {
            final var _resultValue = new DirectoryRoleCollectionRole();
