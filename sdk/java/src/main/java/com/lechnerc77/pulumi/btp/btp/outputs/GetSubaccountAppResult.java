...
import com.lechnerc77.pulumi.btp.btp.outputs.GetSubaccountAppOauth2Configuration;
...
@CustomType
public final class GetSubaccountAppResult {
    ...
    private GetSubaccountAppOauth2Configuration oauth2Configuration;
    ...
    public GetSubaccountAppOauth2Configuration oauth2Configuration() {
    ...
    public static Builder builder(GetSubaccountAppResult defaults) {
    ...
    public static final class Builder {
        ...
        private String xsappname;
        public Builder() {}
        public Builder(GetSubaccountAppResult defaults) {
        ...
        @CustomType.Setter
        public Builder oauth2Configuration(GetSubaccountAppOauth2Configuration oauth2Configuration) {
        ...
        public GetSubaccountAppResult build() {
            final var _resultValue = new GetSubaccountAppResult();
