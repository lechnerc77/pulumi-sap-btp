...
__all__ = [
    'GetSubaccountServicePlansResult',
    'AwaitableGetSubaccountServicePlansResult',
    'get_subaccount_service_plans',
    'get_subaccount_service_plans_output',
]

@pulumi.output_type
class GetSubaccountServicePlansResult:
    """
    ...
    @property
    @pulumi.getter
    def values(self) -> Sequence['outputs.GetSubaccountServicePlansValueResult']:
        return pulumi.get(self, "values")


class AwaitableGetSubaccountServicePlansResult(GetSubaccountServicePlansResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSubaccountServicePlansResult(
...
def get_subaccount_service_plans(environment: Optional[str] = None,
                                 fields_filter: Optional[str] = None,
                                 labels_filter: Optional[str] = None,
                                 subaccount_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSubaccountServicePlansResult:
    """
    ...
    :param str environment: Filter the response on the environment (sapbtp, kubernetes, cloudfoundry).
    :param str fields_filter: Filters the response based on the field query.
    ...
    __ret__ = pulumi.runtime.invoke('btp:index/getSubaccountServicePlans:getSubaccountServicePlans', __args__, opts=opts, typ=GetSubaccountServicePlansResult).value

    return AwaitableGetSubaccountServicePlansResult(
...
@_utilities.lift_output_func(get_subaccount_service_plans)
def get_subaccount_service_plans_output(environment: Optional[pulumi.Input[Optional[str]]] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSubaccountServicePlansResult]:
    """
    Lists the plans of services that your subaccount is entitled to use in your environment.
