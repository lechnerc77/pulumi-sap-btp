...
__all__ = [
    'GetSubaccountEnvironmentsResult',
    'AwaitableGetSubaccountEnvironmentsResult',
    'get_subaccount_environments',
    'get_subaccount_environments_output',
]

@pulumi.output_type
class GetSubaccountEnvironmentsResult:
    """
    ...
    @property
    @pulumi.getter
    def values(self) -> Sequence['outputs.GetSubaccountEnvironmentsValueResult']:
        return pulumi.get(self, "values")


class AwaitableGetSubaccountEnvironmentsResult(GetSubaccountEnvironmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSubaccountEnvironmentsResult(
            id=self.id,
            subaccount_id=self.subaccount_id,
            values=self.values)


def get_subaccount_environments(subaccount_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSubaccountEnvironmentsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('btp:index/getSubaccountEnvironments:getSubaccountEnvironments', __args__, opts=opts, typ=GetSubaccountEnvironmentsResult).value

    return AwaitableGetSubaccountEnvironmentsResult(
        id=pulumi.get(__ret__, 'id'),
        subaccount_id=pulumi.get(__ret__, 'subaccount_id'),
        values=pulumi.get(__ret__, 'values'))


@_utilities.lift_output_func(get_subaccount_environments)
def get_subaccount_environments_output(subaccount_id: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSubaccountEnvironmentsResult]:
    """
    Gets all the available environments for a subaccount.
