...
__all__ = [
    'GetSubaccountRoleResult',
    'AwaitableGetSubaccountRoleResult',
    'get_subaccount_role',
    'get_subaccount_role_output',
]

@pulumi.output_type
class GetSubaccountRoleResult:
    """
    A collection of values returned by getSubaccountRole.
    """
    def __init__(__self__, app_id=None, description=None, id=None, name=None, read_only=None, role_template_name=None, scopes=None, subaccount_id=None):
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Sequence['outputs.GetSubaccountRoleScopeResult']:
        """
...
class AwaitableGetSubaccountRoleResult(GetSubaccountRoleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSubaccountRoleResult(
            app_id=self.app_id,
...
def get_subaccount_role(app_id: Optional[str] = None,
                        name: Optional[str] = None,
                        role_template_name: Optional[str] = None,
                        subaccount_id: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSubaccountRoleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('btp:index/getSubaccountRole:getSubaccountRole', __args__, opts=opts, typ=GetSubaccountRoleResult).value

    return AwaitableGetSubaccountRoleResult(
...
@_utilities.lift_output_func(get_subaccount_role)
def get_subaccount_role_output(app_id: Optional[pulumi.Input[str]] = None,
                               name: Optional[pulumi.Input[str]] = None,
                               role_template_name: Optional[pulumi.Input[str]] = None,
                               subaccount_id: Optional[pulumi.Input[str]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSubaccountRoleResult]:
    """
    Gets details about a specific subaccount role.
