...
__all__ = [
    'GetDirectoryRoleResult',
    'AwaitableGetDirectoryRoleResult',
    'get_directory_role',
    'get_directory_role_output',
]

@pulumi.output_type
class GetDirectoryRoleResult:
    """
    A collection of values returned by getDirectoryRole.
    """
    def __init__(__self__, app_id=None, description=None, directory_id=None, id=None, name=None, read_only=None, role_template_name=None, scopes=None):
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Sequence['outputs.GetDirectoryRoleScopeResult']:
        """
...
class AwaitableGetDirectoryRoleResult(GetDirectoryRoleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDirectoryRoleResult(
            app_id=self.app_id,
...
def get_directory_role(app_id: Optional[str] = None,
                       directory_id: Optional[str] = None,
                       name: Optional[str] = None,
                       role_template_name: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDirectoryRoleResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('btp:index/getDirectoryRole:getDirectoryRole', __args__, opts=opts, typ=GetDirectoryRoleResult).value

    return AwaitableGetDirectoryRoleResult(
...
@_utilities.lift_output_func(get_directory_role)
def get_directory_role_output(app_id: Optional[pulumi.Input[str]] = None,
                              directory_id: Optional[pulumi.Input[str]] = None,
                              name: Optional[pulumi.Input[str]] = None,
                              role_template_name: Optional[pulumi.Input[str]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDirectoryRoleResult]:
    """
    Gets details about a specific directory role.
